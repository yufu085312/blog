---
title: "現場視点で学ぶ Git & GitHub 入門【チーム開発の基本】"
date: 2025-11-20T12:55:00+09:00
lastmod: 2026-02-11T16:16:00+09:00
...
### `git push`：変更をGitHubに送る
```bash
git push origin feature/login
```
ローカルで確定したコミットを、GitHub上のリポジトリに反映します。

👉 ボリュームを増やさず、事故防止だけできるのでおすすめ。
...
Pull Requestを使うことで、コンフリクトも
「個人で抱え込まず、チームで安全に解決」できます。
...
Gitは「履歴を安全に積み重ねる道具」、
GitHubは「チームで安心して開発するための場所」です。

まずは、
- `git status` をこまめに確認する
- main では作業しない
- PRは怖がらずに出す

この3つを意識するだけで、Gitによる事故は大きく減らせます。
